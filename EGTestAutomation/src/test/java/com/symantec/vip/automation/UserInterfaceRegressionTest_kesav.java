...
public class UserInterfaceRegressionTest_kesav extends TestBase {
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "test", groups = { "baseconfig", "SanityTests", "RegressionTests" })
...
*/
	/*@Test(priority = 0, dataProviderClass = DataProvider.class, dataProvider = "CreateUserStoreBasic", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	public void ACreateUserStoreBasic(HashMap<String, String> configuration) throws Exception {
		configuration.putAll(config);
		logger.info("Thread-" + Thread.currentThread().getId() + ": " + "**********Configuration for this test is**********" + configuration);
		sTestHelper.CreateUserStore(configuration, driver);
	}

	@Test(dataProviderClass = DataProvider.class, dataProvider = "CreateValidationServerBasic", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "UpdateValidationServerULO", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {"ACreateUserStoreBasic" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "UpdateValidationServerULUO", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {"ACreateUserStoreBasic" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "UpdateValidationServerRadiusLDAPMappingULO", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {"ACreateUserStoreBasic" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "DuplicateValidationServerWithULUO", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {
		"Configure_Syslog_Servers", "ACreateUserStoreBasic" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "AddVIPCertificate", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "UpdateValidationServerAutoBCMode", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "AddSSLCertificate", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {"ACreateUserStoreBasic" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "Test_SSPIDP_login_DiffFormat", priority = 5, groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "UpdateSettingsData", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "ConsoleSettingHTTPSLogin", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "AddTunnelForwarderWithSSLCert", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "ConfigureConsoleAuthenticate", groups = { "baseconfig", "SanityTests", "RegressionTests" }, priority = 5)
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "SystemSettingData", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "SysLogData", groups = { "baseconfig", "SanityTests", "RegressionTests" }, priority = 5)
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "CreateValidationServerNegative", groups = { "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "ConfigureProxy", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "ExportSettingsData", groups = { "baseconfig", "SanityTests", "RegressionTests" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "SSPIDPLoginDiffDN", groups = { "baseconfig", "SanityTests", "RegressionTests" }, priority = 5)
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "ULOValidationServerWithDifferentBindDNInUserstore", groups = { "baseconfig", "SanityTests", "RegressionTests" }, priority = 5)
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "VIPAdministratorConfigWithDiffDNUserStore", groups = { "baseconfig", "SanityTests", "RegressionTests" }, priority = 5)
