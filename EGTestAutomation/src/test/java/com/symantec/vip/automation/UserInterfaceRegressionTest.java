...
public class UserInterfaceRegressionTest extends TestBase {
	...
	@Test(priority = 0, dataProviderClass = DataProvider.class, dataProvider = "CreateUserStoreBasic", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = { "AddVIPCertificate_FirstTime" })
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "AddSSLCertificate", groups = { "baseconfig", "SanityTests", "RegressionTests" }, dependsOnMethods = {
			"AddVIPCertificate_FirstTime", "CreateUserStoreBasic" })
