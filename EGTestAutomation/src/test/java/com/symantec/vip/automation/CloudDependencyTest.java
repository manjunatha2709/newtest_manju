...
public class CloudDependencyTest extends TestBase {
	...
	@Test(dataProviderClass = DataProvider.class, dataProvider = "SSPIDPLoginWithoutSSL", groups = { "SanityTests", "RegressionTests" }, dependsOnMethods = { "Start_SSP_Service" })
